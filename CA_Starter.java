...
//				System.err.println("Available actions : " + game.availableActions());
    ...
    static Option chooseBestAction(List<Option> options) {
        ...
        for (Action.Option option : options) {
        ...
        System.err.println("Best action : " + bestAction + " with score: " + highestScore + " at coordinates X: " + bestOption.neighbour.pos.x
                + ", Y: " + bestOption.neighbour.pos.y);
        return bestOption;
    }
...
enum Actions {
    GROW, WAIT, TENTACLE, SPORER, HARVESTER, BASIC;
}
